 ...
 ******************************************************************************
*/
#ifndef _RANDOM_GENERATOR_CLASS
#define _RANDOM_GENERATOR_CLASS


class CRandomGenerator
{

   // never expecting that someone would actually create an instance of this
   CRandomGenerator(void) {};
   ~CRandomGenerator(void) {};
   
public:

   static int GetIntRange(int, int, bool = true);
   static int GetIntLen(int);

   static void GetRandomData(int, char *);
};
