 ...
 ******************************************************************************
*/
#ifndef _SDB_ACCESSOR
#define _SDB_ACCESSOR

/*
   CSDBAccessor handles adding, getting, updating or removing a file from
   a SDB File.
...
{
private:
   CSBDDetailRec  oRecord;

public:
   CSDBAccessor(const CSBDDetailRec &);
   virtual ~CSDBAccessor(void);
   ...
   const CSBDDetailRec &Record(void) { return oRecord;};
   void Record(const CSBDDetailRec &rRec) { oRecord = rRec;};
