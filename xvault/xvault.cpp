 ...
 ******************************************************************************
*/
// xvault.cpp : Defines the entry point for the console application.
//

#include "stdafx.h"
#include "main.h"

// nothing more than a wrapper for a common main.  should be
// able to share xVaultMain with all command line builds (win, linux, etc...)
//
int _tmain(int argc, _TCHAR* argv[])
{
	return xVaultMain(argc, argv);
}
